...
namespace EF.Repo
{
    public class TeachTeacherSchoolClassRepo : RepositoryBase<TeachTeacherSchoolClass>
    {
        ...
        public TeachTeacherSchoolClassRepo(InMemoryContext testDataContext) : base(testDataContext)
        {
        ...
        public void MakeTestData()
        {
            if (testDataContext != null)
            {
                ...
                testDataContext.TeachTeacherSchoolClasses.Add(new TeachTeacherSchoolClass(4, 5));
                ...
                testDataContext.TeachTeacherSchoolClasses.Add(new TeachTeacherSchoolClass(6, 3));
                ...
                testDataContext.TeachTeacherSchoolClasses.Add(new TeachTeacherSchoolClass(2, 9));
